                         ...
                         <div class="button_group3">
                             ...
                             <form action="/disciplines-create" method="get">
                                 ...
                                 <form action="/discipline-modify" method="get" id="modifyDiscipline">
                                   <input type="hidden" name="idHiddenDisciplineToModify" id="idHiddenDisciplineToModify">
                                 <input class="button_terms" type="submit" value="Модифицировать выбранную дисциплину…" onclick="modifyDiscipline()">
                                </form>
                                 <br>
                                 ...
                                 <form action="/disciplines-delete" method="post" id="deleteDiscipline">
                                  ...
                                  <input class="button_terms" type="submit" value="Удалить выбранную дисциплину…" onclick="deleteDiscipline()">
                              </form>
